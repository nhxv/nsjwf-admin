      ...
      <div className="flex flex-col">
        <div className="mb-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="block text-[0.625rem] font-serif">
        ...
        {order.productCustomerOrders.map((productOrder) => (
          <div
            ...
            className="flex py-2 w-9/12 border-black border-b ml-24"
          >
            <div className="w-[32px] text-xs text-center font-semibold">
