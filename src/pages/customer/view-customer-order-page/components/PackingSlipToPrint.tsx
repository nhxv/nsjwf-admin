...
export default function PackingSlipToPrint({ printRef, order }) {
  ...
  <div ref={printRef} className="px-6 py-4 break-after-page">
    <div className="flex flex-col">
      <div className="mb-8">
        <h1 className="block text-[0.5rem] font-serif">New San Jose Wholesale Foods, Inc.</h1>
        <p className="block text-[0.375rem]">1005 S. 5th St, San Jose, CA 95112</p>
        <p className="block text-[0.375rem]">Mailing Address: P.O. Box 730967, San Jose, CA 95173 - 0967</p>
        <p className="block text-[0.375rem]">Tel: (408) 279-3888 • (408) 279-3889 • (408) 279-0413 • Fax: (408) 279-3890</p>
      </div>
