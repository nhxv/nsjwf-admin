  ...
  if (role === Role.OPERATOR) {
    return (
      <div className="btm-nav sticky h-20 py-2 dark:bg-base-200 border border-t-base-300 border-l-0 border-r-0 border-b-0">
        ...
        className={
          navData => navData.isActive ? `bg-info text-info-content rounded-btn mx-1` : `rounded-btn hover:bg-base-200 dark:hover:bg-base-300 mx-1`
        }>
    ...
    return (
      <div className="btm-nav sticky h-20 py-2 dark:bg-base-200 border border-t-base-300 border-l-0 border-r-0 border-b-0">
        <NavLink to="/customer/draft-customer-order" className={
          navData => navData.isActive ? `bg-info text-info-content rounded-btn md:flex hidden mx-1` : `rounded-btn  hover:bg-base-200 dark:hover:bg-base-300 md:flex hidden mx-1`
        }>
