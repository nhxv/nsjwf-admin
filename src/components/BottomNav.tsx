import { BiLogInCircle, BiLogOutCircle, BiHomeAlt, BiShoppingBag, BiClipboard, BiBarChartAlt2, BiLineChart, BiDollar } from "react-icons/bi";
    ...
    return (
      <div className="btm-nav sticky h-20 border border-b-0 border-l-0 border-r-0 border-t-base-300 py-2 dark:bg-base-200">
        ...
        <NavLink
          to="/task/view-task"
          className={(navData) =>
            navData.isActive ? `rounded-btn mx-1 bg-info text-info-content` : `rounded-btn mx-1 hover:bg-base-200 dark:hover:bg-base-300`
          }>
