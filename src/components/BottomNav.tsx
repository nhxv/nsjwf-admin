  ...
  return (
    <>
      {role === Role.OPERATOR ? (
        ...
        <div className="btm-nav h-20 py-2 border border-t-gray-300 border-l-0 border-r-0 border-b-0">
          <NavLink to="/customer/draft-customer-order" className={navData => navData.isActive ? `bg-success text-primary rounded-btn mx-1 md:flex hidden` : `rounded-btn mx-1 hover:bg-gray-100 md:flex hidden`}>
          ...
          <NavLink to="/vendor/draft-vendor-order" className={navData => navData.isActive ? `bg-success text-primary rounded-btn mx-1 md:flex hidden` : `rounded-btn mx-1 hover:bg-gray-100 md:flex hidden`}>
